...
while True:  # main menu loop
    ...
    print('Choose 4 if you want to edit TO-DO task.')
    print('Choose 5 if you want to save TO-DO list to .txt file.')
    ...
    if choice_main_menu == '4':  # menu for editing tasks in TO-DO list
        os.system('cls')  # clear screen (windows cli syntax)
        print_lists()
        print('Choose 1 if you want to edit TO-DO tasks.')
        print('Choose 2 if you want to edit DONE_LIST tasks.')
        choice_4th_submenu = input('Choose: ')  # 2nd menu control options
        if choice_4th_submenu == '1':  # choice to go back to main menu
            while True:
                os.system('cls')  # clear screen (windows cli syntax)
                print('TO-DO LIST TASKS: \n')
                print(f"{'NUMBER':<10} {'TASKS'}")  # string formating to add column names for 'task index' & 'task name'
                ...
                print('Choose 2 if you want to go back.')
                choice_2nd_menu_todo = input('Choose: ')  # 2nd menu control options
                if choice_2nd_menu_todo == '2':  # choice to go back to main menu
                    print('going back to main menu.')
                    time.sleep(1)
                    break
        if choice_4th_submenu == '2':  # choice to go back to main menu
            while True:
                os.system('cls')  # clear screen (windows cli syntax)
                ...
                print('Choose 1 if you want edit another task.')
                print('Choose 2 if you want to go back.')
                choice_2nd_menu_done = input('Choose: ')  # 2nd menu control options
                if choice_2nd_menu_done == '2':  # choice to go back to main menu
                    print('going back to main menu.')
                    time.sleep(1)
                    break


    if choice_main_menu == '5':  # menu for task saving TO-DO LIST to .txt file
        while True:
            os.system('cls')  # clear screen (windows cli syntax)
            print('TO-DO LIST TASKS: \n')
            print(f"{'NUMBER':<10} {'TASKS'}")  # string formating to add column names for 'task index' & 'task name'
            ...
            print('Choose 2 if you want to go back.')
            choice_5th_menu = input('Choose: ')  # 3rd menu control options
            if choice_5th_menu == '1':
                ...
                break
            if choice_5th_menu == '2':  # choice to go back to main menu
                print('going back to main menu.')
                time.sleep(1)
                break
